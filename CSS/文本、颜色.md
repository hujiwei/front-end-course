...
一个例子：
![number和percentage继承对比](line-height.gif "number和percentage继承对比")

#### font
```
font:[[<font-style>||<font-variant>||<font-weight>||<font-stretch>]? <font-size>[/<line-height>]?<font-family>]|caption|icon|menu|message-box|small-caption|status-bar

例子：font:30px/2 "Consolas",monospace;
例子：font:italic bold 20px/1.5 arial,serif;
```
...
```
![white-space的值](white-space.gif "white-space的值")
